...
import by.it_academy.jd2.task_sql.service.factory.ObjectMapperFactory;
...
@WebServlet(name = "ApiFlightsServletJson", urlPatterns = "/api/flights")
public class ApiFlightServletJson extends HttpServlet {
